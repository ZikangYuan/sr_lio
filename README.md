...
Thanks for @chengwei for solving the problem that SR-LIO cannot run successfully under the specific mode (motion_compensation: CONSTANT_VELOCITY, distance: POINT_TO_PLANE).
